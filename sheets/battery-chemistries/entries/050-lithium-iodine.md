...
## Description
The pacemaker battery: a solid-state primary in which a lithium anode and iodine-polymer cathode react through a self-forming lithium iodide electrolyte layer. No liquid, no separator, no gas generation — nothing to leak inside a human chest. Current output is tiny (microamps), but a pacemaker needs little more, and the chemistry delivers it with near-perfect reliability for 5–15 years per implant.
