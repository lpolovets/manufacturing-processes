...
## Description
The canonical flow battery: vanadium ions in sulfuric acid, pumped from tanks through a membrane-divided stack, with vanadium's four oxidation states supplying both sides — so electrolyte crossover degrades nothing permanently. Power (stack size) and energy (tank size) decouple, making long durations incrementally cheap, and the electrolyte never wears out: it can be rebalanced, reused, or even leased.
