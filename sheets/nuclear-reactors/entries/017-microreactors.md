...
## Description
Nuclear as a product, not a project: 100 kWe–20 MWe units designed for factory assembly, truck transport, and unattended or minimally-staffed operation. Most use TRISO fuel and either heat pipes (solid-state cooling with no pumps — Westinghouse eVinci) or compact gas cycles. The target customers don't buy $/MWh — they buy power where the grid isn't: remote mines, military bases, disaster response, Arctic communities, and increasingly, data centers wanting dedicated on-site generation.
