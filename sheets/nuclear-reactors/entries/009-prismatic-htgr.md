...
These are the highest demonstrated outlet temperatures in fission, the core mechanics are well characterized, and you get the same walk-away TRISO safety case. Weaknesses: batch refueling requires complex block shuffling; graphite blocks cost money to machine and replace; power density and big-vessel economics are as bad as in any HTGR; and the commercial bench is thinner than the pebble-bed camp's. The design's fifty-year history (Peach Bottom, Fort St. Vrain's troubled run, GA's cancelled GT-MHR) is full of prototypes and short on fleets.
