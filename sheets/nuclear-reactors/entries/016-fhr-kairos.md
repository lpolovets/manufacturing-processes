---
number: 16
name: Fluoride-Salt-Cooled High-Temperature Reactor (FHR)
part: 5
group: Molten salt
fuel: [haleu]
capex: med
...
## Description
The pragmatist's molten-salt reactor: keep the fuel solid (TRISO pebbles, already qualified) and use clean fluoride salt (FLiBe) only as coolant. This sidesteps liquid-fuel licensing entirely — the salt is hot and low-pressure but barely radioactive — while retaining 650 °C output and pebble-bed walk-away safety. Kairos Power built its company culture around iterative hardware: non-nuclear salt test loops, then the Hermes demo, then power reactors, each unit deliberately disposable learning.
