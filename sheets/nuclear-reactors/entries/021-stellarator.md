...
## Description
The tokamak's twisted sibling: instead of driving current through the plasma, the confinement twist is built entirely into fiendishly-shaped external magnets. No plasma current means no disruptions and inherently steady-state operation — the two problems that most threaten tokamak power plants simply don't exist. The price was always that the 3D coil shapes were unbuildable; Germany's Wendelstein 7-X (designed by supercomputer, built over 15 years) proved they no longer are.
