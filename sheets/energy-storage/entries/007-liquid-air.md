...
## Description
Liquefy air at -196 °C using off-peak power, store it in insulated tanks at atmospheric pressure, then pump, reheat, and expand it through turbines to discharge. Because the reservoir is a standard cryogenic tank rather than a cavern or mountain, LAES sites anywhere, and it borrows a century of industrial-gas equipment (the entire plant is assembled from air-separation and LNG components). Waste heat and cold recycling are what lift round-trip efficiency from ~25% to 50–60%.
