...
## Description
The largest battery fleet ever built is parked in driveways: EV packs sum to terawatt-hours, sitting idle 95% of the time. V2G discharges them back through bidirectional chargers to serve the grid; its milder sibling, smart charging (V1G), just times the charging. The storage capacity is effectively free — the vehicles were bought for transport — making V2G the cheapest marginal kWh of flexibility in existence, if the coordination problem can be solved.
