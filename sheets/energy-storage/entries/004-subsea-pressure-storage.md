...
## Description
Use the ocean as the upper reservoir: anchor hollow concrete spheres on the deep seabed, let seawater rush in through a turbine to discharge, and pump it back out against hundreds of meters of hydrostatic head to charge. Depth is the "elevation" — at 700 m, each cubic meter stores what pumped hydro gets from a 700 m mountain. Co-locates naturally with offshore wind, storing energy where it's generated.
