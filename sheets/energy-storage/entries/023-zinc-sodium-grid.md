---
number: 23
name: Zinc & Sodium Grid Batteries
part: 5
...
## Description
The supporting cast of stationary electrochemistry: zinc-halide static batteries (Eos), rechargeable zinc-air, high-temperature sodium-sulfur (NGK's decades-old fleet), and the incoming wave of sodium-ion containers. Each attacks lithium on a different flank — zinc on fire safety and non-Chinese supply chains, Na-S on proven long-duration fleet history, Na-ion on materials cost with drop-in manufacturing. (Chemistry detail lives in the Battery Chemistries sheet.)
