...
Tooling is inexpensive, which suits prototypes and low-volume axisymmetric parts. Production is slower than stamping, and the geometry has to be rotationally symmetric.
